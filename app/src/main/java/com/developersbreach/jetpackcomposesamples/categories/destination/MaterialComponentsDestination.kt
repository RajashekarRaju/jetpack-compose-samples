...
@Composable
fun MaterialComponentsDestination(
    ...
    Surface(
        ...
        Scaffold(
            ...
            MaterialComponentCategories(selectedCategory, categoriesViewModel)
        }
    }
}

@Composable
fun MaterialComponentCategories(
    selectedCategory: (Int) -> Unit,
    categoriesViewModel: CategoriesViewModel
) {
    ...
    LazyColumn(
        ...
        items(categoriesViewModel.getMaterialComponentsList) { item ->
